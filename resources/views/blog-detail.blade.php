...
<div class="container-fluid py-6 px-5">
    <div class="row g-5">
        <div class="col-lg-8">
            <!-- Blog Detail Start -->
            <div class="mb-5">
                <img class="img-fluid w-100 mb-5" src="{{url('asset/img/blog-1.jpg')}}" alt="">
            ...
            <div class="mb-5">
                ...
                <div class="d-flex mb-4">
                    <img src="{{url('asset/img/user.jpg')}}" class="img-fluid rounded-circle" style="width: 45px; height: 45px;">
                    <div class="ps-3">
        ...
        <div class="col-lg-4">
            ...
            <div class="mb-5">
                ...
                <div class="d-flex mb-3">
                    <img class="img-fluid" src="{{url('asset/img/blog-1.jpg')}}" style="width: 100px; height: 100px; object-fit: cover;" alt="">
            ...
            <!-- Image Start -->
            <div class="mb-5">
                <img src="{{url('asset/img/blog-1.jpg')}}" alt="" class="img-fluid">
            </div>
            <!-- Image End -->
